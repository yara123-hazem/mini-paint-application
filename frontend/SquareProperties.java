...
public class SquareProperties extends Node {
    private MyPanel myPanel;

    /**
     * Creates new form SquareProperties
     */
    public SquareProperties(java.awt.Frame parent, boolean modal) {
        //super(parent, modal);
        initComponents();
    }
    public SquareProperties(MyPanel myPanel) {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Enter side lenght");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(lengthTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void doneButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doneButtonActionPerformed
        // TODO add your handling code here:
        if (xTextField.getText().isBlank() || yTextField.getText().isBlank() || lengthTextField.getText().isBlank()) {
            ...
            try {
                ...
                if (l < 0) {
                    ...
                    Rectangle r = new Rectangle(x,y,l,l,bColor,fColor);
                    myPanel.addShape(r);
                ...
                JOptionPane.showMessageDialog(null, "Coordinates and side length must be numeric values.");
            }
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SquareProperties dialog = new SquareProperties(new javax.swing.JFrame(), true);
